        ...
        if isinstance(tree, list):
            if isinstance(tree[0], Reserved):
                if tree[0].value == 'if':
                    ...
                    # Length of 3 is a parsed 'else' statement
                    if len(tree[1]) == 3:
                    ...
                    # Initial While loop condition test
                    condition = self.interpret(tree[1][0])

                    while condition.value == 1:
                        # Since the condition is true, perform the statement
                        # Print the result
                        print(self.interpret(tree[1][1]))
                        # Subsequent while loop condition test
                        condition = self.interpret(tree[1][0])
